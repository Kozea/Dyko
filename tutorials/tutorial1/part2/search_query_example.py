...
def search_track_two():
    """Dump the second track of every album."""
...
def search_track_between_8_and_10():
    ...
    condition = And(Condition("track", "<=", 10),
                    Condition("track", ">=", 8),
...
def search_track_1_or_3():
    ...
    print "Searching for track numbers 1 or 3, " \
        "for albums which title begins with 'Chapter'."""
    condition = And(
        Or(Condition("track", "=", 1), Condition("track", "=", 3)),
